...
```{r runPhiscs}
P1 <- muta_cluster(P1, python_env = "module load Anaconda3/2019.07; source activate gurobi",cores=6, tempfolder = paste0(getwd(),"/P342debug")
P2 <- muta_cluster(P2, python_env = "module load Anaconda3/2019.07; source activate gurobi",cores=6, tempfolder = paste0(getwd(),"/P101debug")
```
